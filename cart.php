...
if(isset($_SESSION[$t]))
{
	$product_id=array_column($_SESSION[$t],'product_id');
$result=$db->getdata();
//$ind=array();
...
<button type="submit" class="btn btn-danger mx-20" name="order">Order</button>
</form>
</h6>
</div>
</div>
